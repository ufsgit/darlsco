class CategorySelectModel {
  ...
  factory CategorySelectModel.fromJson(Map<String, dynamic> json) =>
      CategorySelectModel(
...
class PurpleCategorySelectModelElement {
  int fieldCount;
  int affectedRows;
  int insertId;
  String info;
  ...
  PurpleCategorySelectModelElement({
  ...
  factory PurpleCategorySelectModelElement.fromJson(
