...
class HomeEquipmentListScreen extends StatefulWidget {
  ...
  State<HomeEquipmentListScreen> createState() =>
      _HomeEquipmentListScreenState();
}

class _HomeEquipmentListScreenState extends State<HomeEquipmentListScreen> {
    ...
    return isLoading
        ...
        : Scaffold(
            ...
            body: commonBackgroundLinearColorHome(
              childWidget: GetBuilder<HomeController>(builder: (context) {
                return Container(
