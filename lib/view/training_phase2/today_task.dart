...
class _TodayTaskState extends State<TodayTask> {
  ...
  final TodayTaskController todayTaskAttendanceController = Get.put(TodayTaskController());
  // @override
  // void initState() {
  //   super.initState();
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Padding(
                            ...
                            child: Text(
                              "Todays",
                              style: TextStyle(fontSize: 35.sp.h, fontWeight: FontWeight.bold, color: const Color(0xFF294C73)),
                            ),
                          ),
                          Text(
                            'Task',
                      ...
                      GetBuilder(
                          ...
                          builder: (todaysdata) {
                            ...
                            return Column(
                              children: todaysdata.todayTasksLst.isEmpty
                                  ? [
                                      const Center(
                                  ...
                                  : List.generate(
                                      ...
                                      (index) => Padding(
                                        ...
                                        child: Container(
                                          ...
                                          child: todaysdata.todayTasksLst[index].type == 'Training'
                                              ? Padding(
                                                  padding: const EdgeInsets.all(8.0),
                                                  child: Column(
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Column(
                                                          children: [
                                                            ...
                                                            Table(
                                                              border: const TableBorder.symmetric(outside: BorderSide(width: 0, color: Colors.white)),
                                                              children: [
                                                                TableRow(children: [
                                                                  Row(
                                                                    children: [
                                              ...
                                              : Padding(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      GetBuilder<TodayTaskController>(builder: (todayTaskDatas) {
                                                        return Row(
                                                          children: [
                                                            Padding(
                                                              padding: const EdgeInsets.all(8.0),
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: ElevatedButton(
                                                                  ...
                                                                  onPressed: todaysdata.todayTasksLst[index].statusId == '5'
                                                                      ...
                                                                      : () async {
                                                                          ...
                                                                          if (todayTaskDatas.todayTasksLst[index].statusName == 'In Progress') {
                                                                            await todayTaskDatas.getTraineeAttendanceDetails(
                                                                            ...
                                                                            await todayTaskDatas.startExamOrTrainging(
                                                                                examMasterId: todayTaskDatas.todayTasksLst[index].examMasterId.toString(),
                                                                                orderDetailsSubId: todaysdata.todayTasksLst[index].orderDetailsSubId.toString());
                                                                  ...
                                                                  child: Text(
                                                                    todaysdata.todayTasksLst[index].statusName == 'In Progress' ||
                                                                            todaysdata.todayTasksLst[index].statusName == 'Attendance Marked'
                                                                        ? 'Started'
                                                                        : "Start",
                                                                    style: GoogleFonts.dmSans(
                                                                      color: ColorResources.colorBlack,
                                                      ...
                                                      todaysdata.todayTasksLst[index].statusId == '5'
                                                          ? Text(
                                                              todaysdata.todayTasksLst[index].statusName,
