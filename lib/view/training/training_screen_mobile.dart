...
class _TrainingScreenMobileState extends State<TrainingScreenMobile> {
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      child: Obx(() {
        return upcomingInspectionsController.isLoading.value
            ? Scaffold(
                                  ...
                                  Column(
                                    children: List.generate(
                                      ...
                                      (index) => trainningGridWidget(
                                          cWidth: Get.width,
                                          titleText: tcontoller
                                              .commonGridTexts[index]['title'],
                                          subTitle:
                                              tcontoller.commonGridTexts[index]
                                                  ['sub_title'],
                                          icon: tcontoller
                                              .commonGridTexts[index]['icon'],
